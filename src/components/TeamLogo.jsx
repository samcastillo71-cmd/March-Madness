...
export const TeamLogo = memo(function TeamLogo({ espnId, name, size = 22 }) {
  ...
  if (!espnId || err) return (
    <span style={{
      ...
      fontSize: size * 0.42, fontWeight: 800, color: 'var(--paper)',
      flexShrink: 0, border: '1px solid var(--rule)',
